                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="header">
                                            <h4 class="title">Edit Discipline</h4>
                                        </div>
                                        <div class="content">
                                        <form:form action="${root}/discipline.htm" modelAttribute="discipline" method="post">
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label>Discipline ID</label>
                                                        <form:input path="disId" type="hidden" class="form-control"/>
                                                        <input  class="form-control" type="text" disabled="true"  value="${discipline.disId}"/>
                                                ...
                                                <table class="table table-hover table-striped">
                                                    ...
                                                    <tbody>
                                                       <c:set var="stt" value="0"> </c:set>
                                                        <c:forEach var="disciplineDetails" items="${discipline.disciplinedetailses}">
                                                            <tr>
                                                                <td style="width: 80px;">${stt=stt+1}</td>
                                                                <td>${disciplineDetails.employee.name}</td>
                                                                <td>${disciplineDetails.date}</td>
                                                                <td>${disciplineDetails.reason}</td>
                                                                <td>${disciplineDetails.formality}</td>
