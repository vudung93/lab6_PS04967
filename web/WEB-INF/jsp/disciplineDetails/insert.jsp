                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="header">
                                            <h4 class="title">Discipline Detail</h4>
                                        </div>
                                        <div class="content">
                                        <form:form action="${root}/disciplinedetails/add.htm" modelAttribute="disdetails" method="post">
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label>DisciplineDetails ID</label>
                                                        <form:input path="disdtId" type="hidden" class="form-control"/>
                                                        <input  class="form-control" type="text" disabled="true"  value="${disdetails.disdtId}"/>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">                                                       
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${disdetails.employee==null}">
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${disdetails.discipline==null}">
                                                                <select name="discipline.disId" class="form-control">
                                                                    <option value="0">Select Discipline</option>
                                                                    <c:forEach var="discipline" items="${dislist}">
                                                                        <option value="${discipline.disId}">${discipline.disName}</option>
                                                                    </c:forEach>
                                                                </select>
                                                            </c:when>
                                                            <c:when test="${disdetails.discipline!=null}">
                                                                <form:select path="discipline.disId" class="form-control">
                                                                    <form:option value="0">Select Discipline</form:option>
                                                                    <c:forEach var="discipline" items="${dislist}">
                                                                        <form:option value="${discipline.disId}">${discipline.disName}</form:option>
                                                                    </c:forEach>
                                                                </form:select>
                                                            </c:when>
                                                        </c:choose>

                                                        </br>   <div class="kieuchu">${disciplineerr}</div>
                                                    </div>   
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        <label>Date</label>
                                                        <fmt:formatDate value="${disdetails.date}" pattern="yyyy-MM-dd" var="DATE"/>
