                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="header">
                                        <h4 class="title">Employee manage</h4></br>

                                    <a href="${root}/employee/add.htm">  <button  name="btnAdd"  class="btn btn-info btn-fill ">ADD NEW</button></a>
                                    ...
                                    <div id="table-scroll">
                                        <table id="myTable" class="table table-hover table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <form action="${root}/employee/delete.htm">
                                                    <tr>
                                                        <td>${stt=stt+1}</td>
                                                        <td>${emp.name}</td>
                                                        <td>${emp.salary}</td>
                                                        ...
                                                        <c:url var="del" value="/employee/edit.htm">
                                                            <c:param name="txtManv" value="${emp.employeeId}"/>
