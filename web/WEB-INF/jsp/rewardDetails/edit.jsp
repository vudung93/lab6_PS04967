                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="content">
                                        <form:form action="${root}/rewarddetails.htm" modelAttribute="rewdetails" method="post">
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label>RewardDetails ID</label>
                                                        <form:input path="rewdtId" type="hidden" class="form-control"/>
                                                        <input  class="form-control" type="text" disabled="true"  value="${rewdetails.rewdtId}"/>
