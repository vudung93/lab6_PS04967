                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="header">
                                            <h4 class="title">Department Manage</h4></br>

                                        <a href="${root}/department/add.htm">  <button  name="btnAdd"  class="btn btn-info btn-fill ">ADD NEW</button></a>
                                    ...
                                    <div class="content table-responsive table-full-width">
                                        <table class="table table-hover table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                <form action="${root}/department/delete.htm">
                                                    <tr>
                                                        <td>${stt=stt+1}</td>
                                                        <td>${dep.depName}</td>
                                                        <td>${dep.depPhone}</td>
                                                        <td>${dep.location}</td>
                                                        <td>${dep.employees.size()}</td>
                                                       <c:url var="details" value="/department/details.htm">
                                                            <c:param name="DepID" value="${dep.depId}"/>
                                                       ...
                                                       <td><a href="${details}" >Details</a></td>
                                                        <td>
                                                            <input type="hidden" name="txtdepID" value="${dep.depId}"/>
