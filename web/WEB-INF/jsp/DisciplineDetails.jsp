            ...
            <jsp:include page="menu.jsp"></jsp:include>
                ...
                <jsp:include page="navigationBar.jsp"></jsp:include>
                    ...
                    <div class="content">
                        ...
                        <c:choose>
                            <c:when test="${webName2.equals('Discipline')}">
                                <div class="title">
                                    <a class="active1" href="${root}/discipline/show.htm">Discipline</a> 
                                    <a href="${root}/disciplinedetails/show.htm">Discipline Details</a> 

                                </div>
                            </c:when>
                            <c:when test="${webName2.equals('DisciplineDetails')}">
                                <div class="title">
                                    <a  href="${root}/discipline/show.htm">Discipline</a> 
                                    <a class="active1" href="${root}/disciplinedetails/show.htm">Discipline Details</a> 
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="header">
                                        ...
                                        <a href="${root}/disciplinedetails/add.htm">  <button  name="btnAdd"  class="btn btn-info btn-fill ">ADD NEW</button></a>
                                        ...
                                        <div id="table-scroll">
                                            <table class="table table-hover table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <c:forEach var="disdetails" items="${disdetailsList}">
                                                    <form action="${root}/disciplinedetails/delete.htm" method="post">
                                                        <tr>
                                                            <td style="width: 80px;">${stt=stt+1}</td>
                                                            <td>${disdetails.employee.name}</td>
                                                            <td>${disdetails.employee.department.depName}</td>
                                                            <td>${disdetails.discipline.disName}</td>
                                                            <td>${disdetails.date}</td>
                                                            <td>${disdetails.reason}</td>
                                                            <td>${disdetails.formality}</td>

                                                            <c:url var="details" value="/disciplinedetails/edit.htm">
                                                                <c:param name="disdetailsID" value="${disdetails.disdtId}"/>
                                                                <c:param name="STT" value="${stt}"/>
                                                            </c:url> 
                                                            <td style="width: 100px;"><a href="${details}" >Edit</a></td>
                                                            <td style="width: 100px;">
                                                                <input type="hidden" name="txtDisdetailsID" value="${disdetails.disdtId}"/>
