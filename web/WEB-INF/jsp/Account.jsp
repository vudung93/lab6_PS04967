                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="header">
                                        ...
                                        <a href="${root}/account/add.htm">  <button  name="btnAdd"  class="btn btn-info btn-fill ">ADD NEW</button></a>
                                        ...
                                        <div id="table-scroll">
                                            <table class="table table-hover table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <form action="${root}/account/delete.htm" method="post">
                                                        <tr>
                                                            <td>${stt=stt+1}</td>
                                                            <td>${user.username}</td>
                                                            <td>${user.fullname}</td>

                                                            <c:url var="edit" value="/account/reset.htm">
                                                                <c:param name="username" value="${user.username}"/>
                                                               
                                                            </c:url> 
                                                            <td><a href="${edit}" >Reset Pass</a></td>
                                                            <td>
