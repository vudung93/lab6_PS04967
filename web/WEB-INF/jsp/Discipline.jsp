                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="header">
                                        ...
                                        <a href="${root}/discipline/add.htm">  <button  name="btnAdd"  class="btn btn-info btn-fill ">ADD NEW</button></a>
                                        ...
                                        <div id="table-scroll">
                                            <table class="table table-hover table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <c:forEach var="dis" items="${disciplinelist}">
                                                    <form action="${root}/discipline/delete.htm" method="post">
                                                        <tr>
                                                            <td>${stt=stt+1}</td>
                                                            <td>${dis.disName}</td>
                                                            <td>${dis.disciplinedetailses.size()}</td>

                                                            <c:url var="details" value="/discipline/details.htm">
                                                                <c:param name="DisciplineID" value="${dis.disId}"/>
                                                                <c:param name="STT" value="${stt}"/>
                                                            </c:url> 
                                                            <td><a href="${details}" >Details</a></td>
                                                            <td>
                                                                <input type="hidden" name="DiscipID" value="${dis.disId}"/>
